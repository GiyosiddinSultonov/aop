...
public interface CustomerService {
    ...
    ResponseEntity<List<CustomerDto>> getCustomersByFilter(Optional<String> name, Optional<Integer> tier,
                                                           Optional<LocalDate> orderDate);

    ResponseEntity<List<CustomerDto>> getCustomerByTierAndFilter(Integer tier, Optional<String> sort);

    ResponseEntity<List<CustomerDto>> getByTierAndSortByPageable(Integer tier, Optional<String> sortColumnName, Optional<Integer> pageNum, Optional<Integer> size);
}
